...
#         elif self.target_layer_name == 'layer4':
#             return self.model.layer4[-1]
#         elif self.target_layer_name == 'layer2':
#             return self.model.layer2[-1]
#         elif self.target_layer_name == 'layer1':
#             return self.model.layer1[-1]
#         else:
#             raise ValueError("Unsupported target_layer_name. Use 'layer3' or 'layer4' or 'layer2' or 'layer1'   .")

#     def get_gradcam_loader(self):
#         """生成整个 dataset 的 Score-CAM masks 并返回 DataLoader"""
#         self.model.eval()
#         target_layer = self._get_target_layer()
...
class GradCAMLoader:
    ...
    def get_gradcam_loader(self):
        ...
        # ScoreCAM 优化：禁用梯度，eigen_smooth=False
        cam = ScoreCAM(model=self.model, target_layers=[target_layer])
